...
/**
 * @property Urunler_m $Urunler_m
 * @property Siparisler_m $Siparisler_m
 * @property Mclient $mclient                           Async request class
 * @property Mecrypt $mecrypt                            Custom cryptography class
 * @property Blade $blade                              Blade template engine
 * @property Sets $sets                                 Settings in a json file
